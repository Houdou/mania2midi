...
export const scrollSpeedAtom = atomWithStorage<number>('mania2midi_scrollSpeed', 12)
export const laneRatiosAtom = atomWithStorage<number[]>('mania2midi_laneRatios', [1, 1, 1, 1, 1, 1, 1, 1, 1])
export const isProcessingAtom = atom<boolean>(false)
export const processingResultAtom = atom<{ outputDir: string, chunks: string[] } | null>(null)
